...
/*
  ...
  What is this: Your MySQL database tables used character set
  latin1. But utf8 characters had somehow gone into the textual
  columns. You need to change the table character set to utf8. You need
  to transform the utf8 characters in latin1 columns correctly to utf8
  characters in utf8 columns.

  How to use this:

  1. Rename the file name extension of this file to include .php
  (latin1-to-utf8.php).
  ...
  4. Access this php file though a web browser
  (http://localhost/latin1-to-utf8.php) after placing the file in a web
  server. Or else, type "php latin1-to-utf8.php" - without quotes - from
  a terminal.

  Log:
  1. 2009/09/12 by Kamal Wickramanayake at Software View (kamal at
  swview.org) Prepared the mysql hack from Drupal specific script found
  at
  http://www.computerminds.co.uk/drupal-mysql-utf8-and-latin1-character-set-issues
